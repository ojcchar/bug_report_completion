1. To check for inconsistencies in the coded data:
	...
	1.2 Paste the coded data file (csv) in the /bug_report_patterns/test_data/matcher folder
	1.3 Paste the parsed files in the /bug_report_patterns/test_data/data folder

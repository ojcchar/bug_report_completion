...
@SuiteClasses({ ActionsInfinitivePMTest.class, ActionsMultiPMTest.class, ActionsPastPMTest.class,
		...
		CodeRefPMTest.class, ConditionalSequencePMTest.class, CondSequenceParagrahPMTest.class,
		...
		LabeledCodeFragmentsPMTest.class, ConditionalObservedBehaviorPMTest.class })

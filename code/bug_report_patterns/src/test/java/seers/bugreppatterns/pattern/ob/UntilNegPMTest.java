...
public class UntilNegPMTest extends BaseTest {
	...
	public void testPositives() throws Exception {
		String[] txts = { "the changes won't happen until they restart, and offer to restart now." };
	...
	public void testNegatives() throws Exception {
		String[] txts = {
				"The ability to `docker load` xz-compressed images has been broken with docker 1.3.2 (it was working until docker 1.3.1 included).",

...
@RunWith(Suite.class)
@SuiteClasses({ WouldLikePMTest.class, BeforePastClausePMTest.class, BehaveDifferentPMTest.class, BetterToPMTest.class,
		CanQuestionSentencePMTest.class, CanSentencePMTest.class, ConsiderActionPMTest.class, CorrectIsPMTest.class,
		CouldPMTest.class, CouldQuestionSentencePMTest.class, ExpBehaviorLiteralMultiSentencePMTest.class,
		...
		WhyQuestionNegativePMTest.class, WouldBeSentencePMTest.class })

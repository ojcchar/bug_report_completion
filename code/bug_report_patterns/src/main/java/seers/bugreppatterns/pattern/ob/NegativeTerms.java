...
public class NegativeTerms {
	...
	final public static Set<String> VERBS = JavaUtils.getSet("affect", "blink", "block", "break", "bypass", "clear",
			...
			"disappear", "dismiss", "duplicate", "enforce", "erase", "fail", "flicker", "force", "forget", "freeze",
			"glitch", "grow", "hang", "ignore", "increase", "interfere", "interrupt", "jerk", "jitter", "kill", "lack",
			"lose", "loose", "mess", "mishandle", "miss", "mute", "outdate", "overlap", "pause", "prohibit", "reduce",
			"refuse", "reject", "reset", "rest", "restart", "revert", "reverse", "skip", "stick", "stop", "strip",
			"stuck up", "suffer", "terminate", "throw", "time out", "trim", "truncate", "vanish", "terminate", "trim",
			"waste", "wipe");

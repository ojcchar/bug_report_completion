...
public class NegativeTerms {
	final public static String[] ADJECTIVES = { "abnormal", "agressive", "ambiguous", "annoying", "bad", "bizarre",
			...
			"incredible", "indefinite", "inefficient", "infinite", "insecure", "invalid", "lost", "meaningless",
			"messed", "mis-parsed", "misleading", "misplaced", "missing", "mistaken", "null", "odd", "off",
			"off-center", "old", "orphaned", "out-of", "out-of-date", "outdated", "out-dated", "painful", "poor",
			"random", "reduced", "redundant", "repeated", "reversed", "runaway", "semi", "silly", "slow", "spurious",
			"squashed", "strange", "stripped", "stuck", "tedious", "terrible", "tiny", "truncated", "twice", "ugly",
	...
	final public static String[] NOUNS = { "401", "404", "ambiguity", "block", "breakage", "bug", "chaos", "clash",
			...
			"runaway", "segfault", "segmentation", "spam", "stacktrace", "symptom", "trouble", "truncation", "typo",
			"unavailability", "violation", "wait", "warn", "warning", "zombie" };
}

...
public class VerbErrorPM extends ObservedBehaviorPatternMatcher {
	...
	final public static String[] ERROR_TERMS = { "error", "warning", "bug", "violation", "exception", "problem", "npe",
			...
			"collision", "leak", "conflict", "unnavigability", "lock", "zombie", "violation", "confusion", "duplicate",
			"peek", "segfault", "nil pointer", "corruption", "duplicate" , "truncate", "incorrect", "delay", "stacktrace"};

...
public class ParsedBugReport {
    ...
    public ShortLabeledBugReport toShortLabeledBugReport() {
        return new ShortLabeledBugReport(
                id, new ShortLabeledBugReportTitle(title),
                description == null ? null : description.toShortLabeledBRDescription());
    }
